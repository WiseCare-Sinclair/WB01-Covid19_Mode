...
class CameraHandler {
    ...
    public interface StreamDataListener {
        void images(FrameDataHolder frameDataHolder);
        void images(Bitmap msxBitmap, Bitmap dcBitmap, ThermalImage thermalImage);
    }
    ...
    private final Camera.Consumer<ThermalImage> handleIncomingImage = new Camera.Consumer<ThermalImage>() {
        ...
        public void accept(ThermalImage thermalImage) {
            ...
            streamDataListener.images(msxBitmap, dcBitmap, thermalImage); // overrided method 여기서 setimage를 해줌
        }
    };
